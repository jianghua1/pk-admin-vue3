...
import { type VpFormSchema, VpEditor } from 'el-admin-components'
...
definePage({
  meta: {
    hideMenu: true,
    title: 'pages.contents.add-edit-form'
  }
})
...
const addEditFormSchema = ref([
  ...
  },
  {
    ...
    span: 24,
    type: '',
    defaultSlot: (props) => <VpEditor class="w-full!" v-model={props.modelValue}></VpEditor>
  }
] as VpFormSchema)
